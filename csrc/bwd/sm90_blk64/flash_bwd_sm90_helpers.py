...
from csrc.bwd.sm90_blk64.flash_bwd_postprocess import FlashAttentionBackwardPostprocess
from csrc.bwd.sm90_blk64.flash_bwd_preprocess import FlashAttentionBackwardPreprocess
...
def _compile_bwd_preprocess(
    ...
    mQ, _, _, mO, mdO, _, _, _, mLSE, mLSElog2, mPdPsum, mdQaccum, _, _ = (
...
_bwd_preprocess.compile_cache = get_jit_cache("bsa_sm90_bwd_pre")
...
def _compile_bwd_postprocess(
    ...
    mQ, _, _, _, _, mdQ, _, _, _, _, _, mdQaccum, _, _ = make_fake_bwd_tensors(
...
_bwd_postprocess_convert.compile_cache = get_jit_cache("bsa_sm90_bwd_post")
