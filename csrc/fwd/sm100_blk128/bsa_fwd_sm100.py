...
class BlockSparseAttnForwardSm100Blk128:
    ...
    def __init__(
        ...
        assert head_dim in supported_head_dims, "SM100 blk128 fwd supports QK dim 64, 96, or 128"
        head_dim_v = head_dim_v if head_dim_v is not None else head_dim
        assert head_dim_v in supported_head_dims, "SM100 blk128 fwd supports value dim 64, 96, or 128"
    ...
    def _setup_attributes(self):
        ...
        self.kv_stage = (224 * 1024 - smem_size_q_o) // smem_size_kv_per_stage
    ...
    def __call__(
        ...
        if const_expr(not self.same_hdim_kv_padded):
            ...
            stage_stride = const_expr(max(stride_sK, stride_sV))
