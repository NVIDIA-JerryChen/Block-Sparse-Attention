...
- **测试/复现文件**：`agent/agent_tests/`
- **Benchmark 文件与结果**：`agent/agent_benchmark/`
- **Profile/NCU/NSYS/Perfsim 文件**：`agent/agent_profiles/`
- **临时工作区、构建缓存、调试数据**：`agent/agent_space/`

`agent/` 整体不被 git 追踪；不要再向
